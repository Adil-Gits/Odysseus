...
Open your terminal (**Git Bash** on Windows, or **Terminal** on Mac) and run the following commands to clone this setup repository and navigate into it:

```bash
git clone [https://github.com/YOUR-USERNAME/odysseus-ai-setup.git](https://github.com/YOUR-USERNAME/odysseus-ai-setup.git)
cd odysseus-ai-setup
